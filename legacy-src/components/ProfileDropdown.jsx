        ...
        ReactDOM.createPortal(
          ...
          >
            ...
            <button
              ...
              className="cursor-pointer w-full flex items-center space-x-2 px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span>{t('buttons.setting', 'Setting')}</span>
            </button> 
            <div className="border-t border-gray-100" />
            <button
